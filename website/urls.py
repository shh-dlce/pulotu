...
from website.apps.core.views import RobotsTxt, frontPage, logUserIn
from website.apps.core.views import CultureIndex,CultureEdit, compareCultures
...
urlpatterns = patterns('',    
	...
	#url(r'^dataset', 'website.apps.core.views.request_form', name="dataset"), #downloads dataset
    url(r'^dataset', TemplateView.as_view(template_name="dataset.html"), name="dataset"),
	url(r'^contactthanks', TemplateView.as_view(template_name="thankyou2.html"), name="thankyou2"),
	url(r'^captcha/',include('captcha.urls')),
	# About
    url(r'^about', 'website.apps.core.views.getPublications', name="about"),
	url(r'^AddPublication', 'website.apps.core.views.AddPublication', name="AddPublication"),
    ...
    url(r'^conditionsofuse', TemplateView.as_view(template_name="conditions.html"), name="conditionsofuse"),
    url(r'^refdownload', 'website.apps.survey.views.download_references', name="download_references"),
    ...
    url(r'^lockedout/$', TemplateView.as_view(template_name="lockouturl.html"), name="lockedout"),
#        url(r'^resetPW/$', 'website.apps.core.views.resetPW', name='resetPW'),
    ...
    url(r'^search/', include("watson.urls", namespace="watson"),{'template_name':"search.html"}),
   # Robots.txt
    ...
    url(r'^edit/source/add$', 'website.apps.core.views.SourceEdit', 
        name="source-add"),
    url(r'^edit/source/(?P<slug>.+)$', 'website.apps.core.views.SourceEdit', 
        name="source-edit"),
	
    # Cultures
    url(r'^culture/$', 'website.apps.core.views.CultureIndex', 
        name="culture-index"),
    url(r'^culture/(?P<slug>.+)$', 'website.apps.core.views.details', 
        name="culture-detail"),
    url(r'^edit/culture/add$', 'website.apps.core.views.CultureEdit', 
        name="culture-add"),
	...
	url(r'^survey/(?P<slug>.+)/$', 'website.apps.survey.views.indexx',
        name="survey-culture-index"),
    url(r'^survey/(?P<culture>.+)/(?P<section>.+)$', 'website.apps.survey.views.SurveySectionEdit', 
    ...
    url(r'^accounts/login/$', 'django.contrib.auth.views.login', 
        ...
        name="login"),
    url(r'^password_reset_complete/$', 'website.apps.core.views.PWreset', name="password_reset_complete"),
    ...
    url(r'^password_reset_confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$', 'django.contrib.auth.views.password_reset_confirm', name="password_reset_confirm"),
