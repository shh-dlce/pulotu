...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_publication', 'slug')


    def backwards(self, orm):
        # Adding field 'Publication.slug'
        db.add_column(u'core_publication', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.category': {
            ...
            'timeFocus': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'core.culture': {
        ...
        u'core.publication': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
