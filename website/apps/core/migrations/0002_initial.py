...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sources', (
            ...
            ('author', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
        ...
        # Adding index on 'Source', fields ['author', 'year']
        db.create_index('sources', ['author', 'year'])


    def backwards(self, orm):
        # Removing index on 'Source', fields ['author', 'year']
        db.delete_index('sources', ['author', 'year'])
