...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Language', fields ['isocode']
        db.create_unique('languages', ['isocode'])


    def backwards(self, orm):
        # Removing unique constraint on 'Language', fields ['isocode']
        db.delete_unique('languages', ['isocode'])
