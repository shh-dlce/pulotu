...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cultures', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('culture', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=128)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Culture'])

        # Adding M2M table for field languages on 'Culture'
        m2m_table_name = db.shorten_name('cultures_languages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('culture', models.ForeignKey(orm[u'core.culture'], null=False)),
            ('language', models.ForeignKey(orm[u'core.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['culture_id', 'language_id'])


    def backwards(self, orm):
        # Deleting model 'Culture'
        db.delete_table('cultures')

        # Removing M2M table for field languages on 'Culture'
        db.delete_table(db.shorten_name('cultures_languages'))
    ...
    models = {
        ...
        u'core.culture': {
            ...
            'culture': ('django.db.models.fields.CharField', [], {'max_length': '128', 'db_index': 'True'}),
