...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('sources', ['slug'])


        # Changing field 'Source.slug'
        db.alter_column('sources', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1000))
        # Adding field 'Culture.fact'
        db.add_column('cultures', 'fact',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Source.slug'
        db.alter_column('sources', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=64, unique=True))
        # Adding unique constraint on 'Source', fields ['slug']
        db.create_unique('sources', ['slug'])

        # Deleting field 'Culture.fact'
        db.delete_column('cultures', 'fact')
