...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Culture', fields ['culture']
        db.create_unique('cultures', ['culture'])


    def backwards(self, orm):
        # Removing unique constraint on 'Culture', fields ['culture']
        db.delete_unique('cultures', ['culture'])
