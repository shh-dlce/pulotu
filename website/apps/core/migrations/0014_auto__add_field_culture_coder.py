...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Culture.coder'
        db.add_column('cultures', 'coder',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Culture.coder'
        db.delete_column('cultures', 'coder')
    ...
    models = {
        ...
        u'core.culture': {
            ...
            'coder': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
