...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Source.year_new'
        db.delete_column('sources', 'year_new')


        # Changing field 'Source.year'
        db.alter_column('sources', 'year', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'Source.year_new'
        db.add_column('sources', 'year_new',
