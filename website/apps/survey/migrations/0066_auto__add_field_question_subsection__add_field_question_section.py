...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.subsection'
        db.add_column('questions', 'subsection',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Sub', null=True, to=orm['core.Section']),
                      keep_default=False)

        # Adding field 'Question.section'
        db.add_column('questions', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Sec', null=True, to=orm['core.Section']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.subsection'
        db.delete_column('questions', 'subsection_id')

        # Deleting field 'Question.section'
        db.delete_column('questions', 'section_id')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'new_section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Subsection'", 'null': 'True', 'to': u"orm['core.Section']"}),
            'new_subsection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Section'", 'null': 'True', 'to': u"orm['core.Section']"}),
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Sec'", 'null': 'True', 'to': u"orm['core.Section']"}),
            'simplified_question': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subsection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Sub'", 'null': 'True', 'to': u"orm['core.Section']"})
        },
        u'survey.response': {
