...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.new_subsection'
        db.add_column('questions', 'new_subsection',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='new_subsection', null=True, to=orm['core.Section']),
                      keep_default=False)

        # Adding field 'Question.new_section'
        db.add_column('questions', 'new_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='new section', null=True, to=orm['core.Section']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.new_subsection'
        db.delete_column('questions', 'new_subsection_id')

        # Deleting field 'Question.new_section'
        db.delete_column('questions', 'new_section_id')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'displayPublic': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'information': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'new_section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new section'", 'null': 'True', 'to': u"orm['core.Section']"}),
            'new_subsection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_subsection'", 'null': 'True', 'to': u"orm['core.Section']"}),
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Subsection'", 'null': 'True', 'to': u"orm['core.Section']"}),
            'simplified_question': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subsection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Section']", 'null': 'True', 'blank': 'True'})
        },
        u'survey.response': {
