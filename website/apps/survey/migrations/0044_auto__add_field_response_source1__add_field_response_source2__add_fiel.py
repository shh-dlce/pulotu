...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('responses', 'source1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source1', null=True, to=orm['core.Source']),
                      keep_default=False)

        # Adding field 'Response.source2'
        db.add_column('responses', 'source2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source2', null=True, to=orm['core.Source']),
                      keep_default=False)

        # Adding field 'Response.source3'
        db.add_column('responses', 'source3',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source3', null=True, to=orm['core.Source']),
                      keep_default=False)

        # Adding field 'Response.source4'
        db.add_column('responses', 'source4',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source4', null=True, to=orm['core.Source']),
                      keep_default=False)

        # Adding field 'Response.source5'
        db.add_column('responses', 'source5',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source5', null=True, to=orm['core.Source']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.source1'
        db.delete_column('responses', 'source1_id')

        # Deleting field 'Response.source2'
        db.delete_column('responses', 'source2_id')

        # Deleting field 'Response.source3'
        db.delete_column('responses', 'source3_id')

        # Deleting field 'Response.source4'
        db.delete_column('responses', 'source4_id')

        # Deleting field 'Response.source5'
        db.delete_column('responses', 'source5_id')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'simplified_question': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'survey.response': {
