...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.response_type'
        db.add_column('questions', 'response_type',
                      self.gf('django.db.models.fields.CharField')(default='Int', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.response_type'
        db.delete_column('questions', 'response_type')
