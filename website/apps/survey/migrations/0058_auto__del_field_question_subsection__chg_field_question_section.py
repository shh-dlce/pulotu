...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('questions', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Section']))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Question.section'
        raise RuntimeError("Cannot reverse this migration. 'Question.section' and its values cannot be restored.")
