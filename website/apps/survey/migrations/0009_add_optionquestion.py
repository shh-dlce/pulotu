...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OptionQuestion'
        db.create_table('questions_option', (
        ...
        db.send_create_signal(u'survey', ['OptionQuestion'])


    def backwards(self, orm):
        # Deleting model 'OptionQuestion'
        db.delete_table('questions_option')
