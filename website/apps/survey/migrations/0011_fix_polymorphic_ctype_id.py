...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ctype = ctype.filter(app_label='survey', model='question').get()
        # note that we're avoiding Django's models here as they crash when they
        # realise that polymorphic_ctype_id onto contenttype is null...
        cursor = connection.cursor()
        query = """UPDATE questions SET polymorphic_ctype_id = {value}"""
        query = query.format(value=ctype.id)
