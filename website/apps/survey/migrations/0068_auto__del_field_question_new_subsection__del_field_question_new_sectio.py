...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('questions', 'new_subsection',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Section', null=True, to=orm['core.Section'], blank=True),
                      keep_default=False)

        # Adding field 'Question.new_section'
        db.add_column('questions', 'new_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Subsection', null=True, to=orm['core.Section'], blank=True),
                      keep_default=False)
