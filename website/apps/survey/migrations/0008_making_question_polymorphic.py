...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.polymorphic_ctype'
        db.add_column('questions', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_survey.question_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.polymorphic_ctype'
        db.delete_column('questions', 'polymorphic_ctype_id')
