...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field manySources on 'Response'
        m2m_table_name = db.shorten_name('responses_manySources')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('response', models.ForeignKey(orm[u'survey.response'], null=False)),
            ('source', models.ForeignKey(orm[u'core.source'], null=False))
        ))
        db.create_unique(m2m_table_name, ['response_id', 'source_id'])
        if not db.dry_run:
            for obj in orm.Response.objects.all():
                obj.manySources.add(obj.data)
                obj.save()


    def backwards(self, orm):
        # Removing M2M table for field manySources on 'Response'
        db.delete_table(db.shorten_name('responses_manySources'))
    ...
    models = {
        ...
        u'survey.response': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manySources': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'sources_info'", 'symmetrical': 'False', 'to': u"orm['core.Source']"}),
