...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.ugh'
        db.add_column('responses', 'ugh',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ugh', null=True, to=orm['survey.Pages']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.ugh'
        db.delete_column('responses', 'ugh_id')
    ...
    models = {
        ...
        u'survey.response': {
            ...
            'ugh': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ugh'", 'null': 'True', 'to': u"orm['survey.Pages']"}),
