...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_pages', (
            ...
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Response'], null=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['Pages'])

        # Deleting field 'Response.page'
        db.delete_column('responses', 'page_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('responses', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Response'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'survey.pages': {
            ...
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Response']", 'null': 'True', 'blank': 'True'})
        },
        u'survey.question': {
