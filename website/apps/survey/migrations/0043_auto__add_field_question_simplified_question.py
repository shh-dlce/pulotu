...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.simplified_question'
        db.add_column('questions', 'simplified_question',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.simplified_question'
        db.delete_column('questions', 'simplified_question')
