...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.publicNumber'
        db.add_column('questions', 'publicNumber',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.publicNumber'
        db.delete_column('questions', 'publicNumber')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'publicNumber': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Section']", 'null': 'True', 'blank': 'True'}),
            'simplified_question': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subsection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Section'", 'null': 'True', 'to': u"orm['core.Section']"})
        },
        u'survey.response': {
