...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Response', fields ['culture', 'question']
        db.create_unique('responses', ['culture_id', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Response', fields ['culture', 'question']
        db.delete_unique('responses', ['culture_id', 'question_id'])
