...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OptionResponse'
        db.create_table('responses_options', (
            (u'response_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['survey.Response'], unique=True, primary_key=True)),
            ('response', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('response_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['OptionResponse'])


    def backwards(self, orm):
        # Deleting model 'OptionResponse'
        db.delete_table('responses_options')
