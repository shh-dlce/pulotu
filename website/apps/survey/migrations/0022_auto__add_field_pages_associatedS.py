...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.associatedS'
        db.add_column(u'survey_pages', 'associatedS',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Source'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.associatedS'
        db.delete_column(u'survey_pages', 'associatedS_id')
