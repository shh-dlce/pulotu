...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.displayPublic'
        db.add_column('questions', 'displayPublic',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.displayPublic'
        db.delete_column('questions', 'displayPublic')
    ...
    models = {
        ...
        u'core.culture': {
            ...
            'coder': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
