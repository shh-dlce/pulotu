...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.page1'
        db.add_column('responses', 'page1',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Response.page2'
        db.add_column('responses', 'page2',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Response.page3'
        db.add_column('responses', 'page3',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Response.page4'
        db.add_column('responses', 'page4',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Response.page5'
        db.add_column('responses', 'page5',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.page1'
        db.delete_column('responses', 'page1')

        # Deleting field 'Response.page2'
        db.delete_column('responses', 'page2')

        # Deleting field 'Response.page3'
        db.delete_column('responses', 'page3')

        # Deleting field 'Response.page4'
        db.delete_column('responses', 'page4')

        # Deleting field 'Response.page5'
        db.delete_column('responses', 'page5')
